      ...
      <Tilt glareEnable tiltEnable tiltMaxAngleX={30} tiltMaxAngleY={30} glareColor="#aaa6c3">
        <div className="bg-tertiary w-full rounded-2xl p-5 sm:w-[300px] h-auto mx-auto">
          ...
          <div
            ...
            className="bg-gradient-to-r mt-4 from-blue-600 to-blue-400 flex w-28 p-1 cursor-pointer items-center justify-center rounded-md shadow-md hover:opacity-90 transition"
          >
